...
describe("testing Location component", () => {
  test("by default the zoom option is set to the selected facility", () => {
    const { getByLabelText } = renderer();
    expect(getByLabelText("This Facility").checked).toBe(true);
  });
  test("click radio button second option to render map marker for all facilities with-in a state", () => {
    const { getByLabelText } = renderer();
    const allFacilitiesRadioBtn = getByLabelText("All facilities in Alabama");
    fireEvent.click(allFacilitiesRadioBtn);
