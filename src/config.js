...
export const config = {
  app: {
    ...
    apiKey: 'PXPWlQGB3wKXotkWN1PbSwbSoM7CoWW0ZMPWYtfc',
    // getConfigValue(
    //   'REACT_APP_EASEY_ECMPS_UI_API_KEY',
    // ),
    host: getConfigValue(
    ...
    path: getConfigValue(
      'REACT_APP_EASEY_ECMPS_UI_PATH',
      '/',
    ),
    env: getConfigValue(
      'REACT_APP_EASEY_ECMPS_UI_ENV',
      'local-dev',
    ),
    published: getConfigValue(
      'REACT_APP_EASEY_ECMPS_UI_PUBLISHED',
      'local',
    ),
    version: getConfigValue(
      'REACT_APP_EASEY_ECMPS_UI_VERSION',
      'v0.0.0',
    ),
    title: getConfigValue(
      'REACT_APP_EASEY_ECMPS_UI_TITLE',
      'ECMPS',
    ),
    ...
    refreshEvalStatusRate: getConfigValueNumber(
      'REACT_APP_EASEY_ECMPS_UI_REFRESH_EVAL_STATUS_RATE_SECONDS',
      5,
    ) * oneSecond,
    refreshEvalStatusTimeout: getConfigValueNumber(
    ...
    clientId: 'avR3m2daan5MdwaAHVD6kFJ7WfJp5NK9rPd9hdxWVpTLn',
    // getConfigValue(
    //   'REACT_APP_EASEY_ECMPS_UI_CLIENT_ID',
    // ),
    clientSecret: 'W3Z5s34gwByPCytpGArFaJAmTqRjYL7BkaqekHLgadf7G',
    // getConfigValue(
    //   'REACT_APP_EASEY_ECMPS_UI_CLIENT_SECRET',
    // ),
    enableDebug: getConfigValueBoolean(
      'REACT_APP_EASEY_ECMPS_UI_ENABLE_DEBUG',
    ),
  },
  services: {
    mdm: {
