...
export const rectWAFsDataTableProps = (location) => {
  return {
    ...
    controlInputs: {
      ...
      numberOfTraversePointsWaf: ["Number of Traverse Points WAF", "input", "" , ""],
...
export const unitControlDataTableProps = (location, selectedLocation) => {
  return {
    ...
    controlInputs: {
      ...
      seasonalControlsIndicator: ["Seasonal Controls Indicator", "radio", "" , ""],
    },
    controlDatePickerInputs: {
...
export const unitCapacityDataTableProps = (location, selectedLocation) => {
  ...
  return {
    ...
    controlInputs: {
      commercialOperationDate: ["Commercial Operation Date", "date", "" , "locked"],
      operationDate: ["Operation Date", "date", "" , "locked"],
      boilerTurbineType: ["Boiler/Turbine Type", "input", "" , "locked"],

      skip: ["", "skip", "" , ""],
      boilerTurbineBeginDate: ["Boiler/Turbine Begin Date", "date", "" , "locked"],
