...
*/
  ...
  //test('renders Cycle Time Injection rows and crud funtionality', async () => {
  //  const qaCycleTimeInjectionData = [
  //    {
  //      "id": "id1",
  //      "testSumId": "testSumId",
  //      "userId": "string",
  ...
  //      "endHour": "string",
  //      "endMinute": "string",
  //      "injectionCycleTime": "string",
  //      "beginMonitorValue": "string",
  //      "endMonitorValue": "string",
  //    },
  //    {
  //      "id": "id2",
  //      "testSumId": "testSumId",
  ...
  //  ]
//
  //  const getUrl = `${qaCertBaseUrl}/locations/${locId}/test-summary/${testSumId}/cycle-time-summaries${cycleTimeSumId}/cycle-time-injections`;
  //  const postUrl = `${qaCertBaseUrl}/workspace/locations/${locId}/test-summary/${testSumId}/cycle-time-summaries/${cycleTimeSumId}/cycle-time-injections`;
  //  const putUrl = new RegExp(`${qaCertBaseUrl}/workspace/locations/${locId}/test-summary/${testSumId}/cycle-time-summaries/${cycleTimeSumId}/cycle-time-injections/${idRegex}`)
  //  const deleteUrl = new RegExp(`${qaCertBaseUrl}/workspace/locations/${locId}/test-summary/${testSumId}/cycle-time-summaries/${cycleTimeSumId}/cycle-time-injections/${idRegex}`)
//
//
  //  mock.onGet(getUrl).reply(200, qaCycleTimeInjectionData)
  //  mock.onPost(postUrl).reply(200, 'created')
  //  mock.onPut(putUrl).reply(200, 'updated')
  //  mock.onDelete(deleteUrl).reply(200, 'deleted')
//
  //  const props = qaCycleTimeInjectionProps()
  //  const idArray = [locId, testSumId, cycleTimeSumId]
  //  const data = { locationId: locId, id: testSumId }
  //  renderComponent(props, idArray, data);
//
  //  // renders rows
  //  const rows = await screen.findAllByRole('row')
  //  expect(mock.history.get.length).not.toBe(0)
  //  expect(rows).toHaveLength(qaCycleTimeInjectionData.length);
//
  //  // add row
  //  const addBtn = screen.getByRole('button', { name: /Add/i })
  //  userEvent.click(addBtn)
  ...
  //  setTimeout(() => expect(mock.history.post.length).toBe(1), 1000)
    ...
    // edit row
   // const editBtns = screen.getAllByRole('button', { name: /Edit/i })
   // expect(editBtns).toHaveLength(qaCycleTimeInjectionData.length)
   // userEvent.click(editBtns[0])
   // saveAndCloseBtn = screen.getByRole('button', { name: /Click to save/i })
   // userEvent.click(saveAndCloseBtn)
   // setTimeout(() => expect(mock.history.put.length).toBe(1), 1000)
    ...
    // remove row
  //  const deleteBtns = await screen.getAllByRole('button', { name: /Remove/i })
  //  expect(deleteBtns).toHaveLength(qaCycleTimeInjectionData.length)
  //  const secondDeleteBtn = deleteBtns[1]
  //  userEvent.click(secondDeleteBtn)
  //  const confirmBtns = screen.getAllByRole('button', { name: /Yes/i })
  //  userEvent.click(confirmBtns[1])
