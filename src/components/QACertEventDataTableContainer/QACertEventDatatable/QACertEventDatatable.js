...
import QACertEventDatatableRender from '../../QACertEventDatatableRender/QACertEventDatatableRender.js';
...
import QAExpandableRowsRender from '../../qaDatatablesContainer/QAExpandableRowsRender/QAExpandableRowsRender.js';

// contains test summary data table

const QACertEventDatatable = ({
  locationSelectValue,
  user,
  nonEditable = false,
  showModal = false,
...
export default QACertEventDatatable;
