          ...
          <div className="grid-row overflow-x-auto">
            <CustomAccordion
              ...
              tables={[
                {
                  content: (
                    <EmissionsViewTable monitorPlanId={selectedConfigId} filterApply={filterApply} setFilterApply={setFilterApply} user={user} viewTemplateSelect={viewTemplateSelect}/>
                  ),
