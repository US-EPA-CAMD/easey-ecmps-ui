...
const mapStateToProps = (state) => {
  return {
    tabs: state.openedFacilityTabs[convertSectionToStoreName(MONITORING_PLAN_STORE_NAME)],
    activeTab: state.activeTab[convertSectionToStoreName(MONITORING_PLAN_STORE_NAME)],
  };
};
