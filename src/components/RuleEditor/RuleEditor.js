  ...
  return (
    <div className="container">
      {/* <div className="row">
        ...
        <div className="col">
          <FormGroup>
            <Label htmlFor="ddlCategory" hint={<> (required)</>}>
              Category
            </Label>
            <Dropdown
              id="ddlCategory"
        ...
        <div className="col">
          <FormGroup>
            <Label htmlFor="ddlRules" hint={<> (required)</>}>
              Rules
            </Label>
            <Dropdown
              id="ddlRules"
      ...
      {selectedRule.isNew || selectedRule.id !== NONE ? (
        <React.Fragment>
          <div className="row">
            <div className="col">
              <FormGroup>
                <Label htmlFor="txtCheckCode" hint={<> (required)</>}>
                  Check Code
                </Label>
                <TextInput
                  type="text"
            ...
            <div className="col">
              <FormGroup>
                <Label htmlFor="txtCheckName" hint={<> (required)</>}>
                  Check Name
                </Label>
                <TextInput
                  type="text"
            ...
            <div className="col">
              <FormGroup>
                <Label htmlFor="ddlRulePriority" hint={<> (required)</>}>
                  Priority
                </Label>
                <Dropdown
                  id="ddlRulePriority"
                  ...
                  onChange={(event) =>
                    onCheckRuleUpdateHandler(event, "priority")
                  }
                >
            ...
            <div className="col">
              <div className="align-bottom display-flex">
                <Checkbox
                  ...
                  onChange={(event) =>
                    onCheckRuleUpdateHandler(event, "active")
                  }
                />
                <Checkbox
                  className="margin-right-20"
                  ...
                  onChange={(event) =>
                    onCheckRuleUpdateHandler(event, "supressable")
                  }
                />
              </div>
            </div>
          ...
          <div className="row">
            <div className="col">
              <FormGroup>
                <Label htmlFor="txtCheckDesc" hint={<> (optional)</>}>
                  Description
                </Label>
                <Textarea
                  id="txtCheckDesc"
                  ...
                  onChange={(event) =>
                    onCheckRuleUpdateHandler(event, "description")
                  }
                />
              </FormGroup>
            </div>
              ...
              <Fieldset className="display-flex">
                {typesList.map((item) => (
                  <Radio
                    ...
                    value={item.code}
                    disabled={
                      !selectedRule.isNew && selectedRule.typeCode !== item.code
                    }
