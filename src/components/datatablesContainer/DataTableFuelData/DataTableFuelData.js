...
export const DataTableFuelData = ({
  ...
  useEffect(() => {
    if (
      ...
      mpApi.getMonitoringFuelDataMethods(locationSelectValue).then((res) => {
  ...
  const saveFuelData = () => {
    ...
    mpApi
      .saveMonitoringFuelData(userInput)
      .then((result) => {
        console.log(result);
        setShow(false);
      })
    ...
    <div className="methodTable">
      ...
      {show ? (
        <Modal
          ...
          exitBTN={createNewFuelData ? "Create FuelData" : `Save and Close`}
          children={
            <div>
              <ModalDetails
