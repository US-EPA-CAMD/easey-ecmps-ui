...
test("tests a configuration with only inactive methods", async () => {
  ...
  axios.put.mockImplementation((url) => {
    switch (url) {
      case `https://easey-dev.app.cloud.gov/api/monitor-plan-mgmt/workspace/locations/3844/defaults/WPC07008-24F0C0E2B4DD4AFC927FC2DEDC67B859`:
  ...
  const title = await mpApi.getMonitoringDefaults(69);
  expect(title.data).toEqual(methodsInactiveOnly);
