...
describe("Test Data Management API calls", () => {
  ...
  test("getAllControlTechnologies", async () => {
    const controlCodesObject = [{ controlCodes: "data" }];
  ...
  test("getAllFuelTypes", async () => {
    const fuelTypeCodesObject = [{ fuelTypeCodes: "data" }];
  ...
  test("getAllUnitTypes", async () => {
    const unitTypeCodesObject = [{ unitTypeCodes: "data" }];
  ...
  test("getAllPrograms", async () => {
    const programCodesObject = [{ programCodes: "data" }];
  ...
  test("getAllAccountTypes", async () => {
    const accountTypeCodesObject = [{ accountTypeCodes: "data" }];
  ...
  test("getAllStates", async () => {
    const stateCodesObject = [{ stateCodes: "data" }];
  ...
  test("getAllBypassApproachCodes", async () => {
    const bypassApproachCodesObject = [{ bypassApproachCodes: "data" }];
  ...
  test("getAllSubstituteDataCodes", async () => {
    const substituteDataCodesObject = [{ substituteDataCodes: "data" }];
  ...
  test("getAllParameterCodes", async () => {
    const parameterCodesObject = [{ parameterCodes: "data" }];
  ...
  test("getAllMethodCodes", async () => {
    const methodCodesObject = [{ methodCodes: "data" }];
  ...
  test("getAllMatsParameterCodes", async () => {
    ...
    mock
      .onGet(matsMethodParameterCodesUrl)
      .reply(200, matsMethodParameterCodesObject);
  ...
  test("getAllMatsMethodCodes", async () => {
    const matsMethodCodesObject = [{ matsMethodCodes: "data" }];
  ...
  test("getAllMaxRateSourceCodes", async () => {
    const maxRateSourceCodesObject = [{ maxRateSourceCodes: "data" }];
  ...
  test("getAllUnitsOfMeasureCodes", async () => {
    const unitsOfMeasureCodesObject = [{ unitsOfMeasureCodes: "data" }];
  ...
  test("getAllRangeCodes", async () => {
    const analyzerRangeCodesObject = [{ analyzerRangeCodes: "data" }];
  ...
  test("getAllSystemTypeCodes", async () => {
    const systemTypeCodesObject = [{ systemTypeCodes: "data" }];
  ...
  test("getAllSystemDesignationCodes", async () => {
    const systemDesignationCodesObject = [{ systemDesignationCodes: "data" }];

    const systemDesignationCodesUrl = `${dataManagementBaseUrl}/system-designation-codes`;
    mock
      .onGet(systemDesignationCodesUrl)
      .reply(200, systemDesignationCodesObject);
  ...
  test("getAllAcquisitionMethodCodes", async () => {
    const acquisitionMethodCodesObject = [{ acquisitionMethodCodes: "data" }];

    const acquisitionMethodCodesUrl = `${dataManagementBaseUrl}/acquisition-method-codes`;
    mock
      .onGet(acquisitionMethodCodesUrl)
      .reply(200, acquisitionMethodCodesObject);
  ...
  test("getAllComponentTypeCodes", async () => {
    const componentTypeCodesObject = [{ componentTypeCodes: "data" }];
  ...
  test("getAllBasisCodes", async () => {
    const basisCodesObject = [{ basisCodes: "data" }];
  ...
  test("getAllSpanMethodCodes", async () => {
    const spanMethodCodesObject = [{ spanMethodCodes: "data" }];
  ...
  test("getAllSpanScaleCodes", async () => {
    const spanScaleCodesObject = [{ spanScaleCodes: "data" }];
  ...
  test("getAllOperatingLevelCodes", async () => {
    const operatingLevelCodesObject = [{ operatingLevelCodes: "data" }];
  ...
  test("getAllOperatingConditionCodes", async () => {
    const operatingConditionCodesObject = [{ operatingConditionCodes: "data" }];

    const operatingConditionCodesUrl = `${dataManagementBaseUrl}/operating-condition-codes`;
    mock
      .onGet(operatingConditionCodesUrl)
      .reply(200, operatingConditionCodesObject);
  ...
  test("getAllDefaultSourceCodes", async () => {
    const defaultSourceCodesObject = [{ defaultSourceCodes: "data" }];
  ...
  test("getAllDefaultPurposeCodes", async () => {
    const defaultPurposeCodesObject = [{ defaultPurposeCodes: "data" }];
  ...
  test("getAllFuelCodes", async () => {
    const fuelCodesObject = [{ fuelCodes: "data" }];
  ...
  test("getAllFuelIndicatorCodes", async () => {
    const fuelIndicatorCodesObject = [{ fuelIndicatorCodes: "data" }];
  ...
  test("getAllDemonstrationMethodCodes", async () => {
    ...
    mock
      .onGet(demonstrationMethodCodesUrl)
      .reply(200, demonstrationMethodCodesObject);
  ...
  test("getAllFormulaCodes", async () => {
    const formulaCodesObject = [{ formulaCodes: "data" }];
  ...
  test("getAllRectangularDuctsCodes", async () => {
    const rectangularDuctsCodesObject = [{ rectangularDuctsCodes: "data" }];

    const rectangularDuctsCodesUrl = `${dataManagementBaseUrl}/waf-method-codes`;
    mock
      .onGet(rectangularDuctsCodesUrl)
      .reply(200, rectangularDuctsCodesObject);
  ...
  test("getAllControlEquipmentParameterCodes", async () => {
    ...
    mock
      .onGet(controlEquipmentParameterCodesUrl)
      .reply(200, controlEquipmentParameterCodesObject);
  ...
  test("getAllProbeTypeCodes", async () => {
    const probeTypeCodesObject = [{ probeTypeCodes: "data" }];
  ...
  test("getAllQualificationTypeCodes", async () => {
    const qualificationTypeCodesObject = [{ qualificationTypeCodes: "data" }];

    const qualificationTypeCodesUrl = `${dataManagementBaseUrl}/qualification-type-codes`;
    mock
      .onGet(qualificationTypeCodesUrl)
      .reply(200, qualificationTypeCodesObject);
  ...
  test("getAllQualificationDataTypeCodes", async () => {
    ...
    mock
      .onGet(qualificationDataTypeCodesUrl)
      .reply(200, qualificationDataTypeCodesObject);
  ...
  test("getAllQualificationLEETestTypeCodes", async () => {
    ...
    mock
      .onGet(qualificationLEETestTypeCodesUrl)
      .reply(200, qualificationLEETestTypeCodesObject);
  ...
  test("getAllMaterialCodes", async () => {
    const materialCodesObject = [{ materialCodes: "data" }];
  ...
  test("getAllShapeCodes", async () => {
    const shapeCodesObject = [{ shapeCodes: "data" }];
  ...
  test("getPrefilteredFormulas", async () => {
    const prefilteredFormulasObject = [{ prefilteredFormulas: "data" }];
  ...
  test("getPrefilteredMethods", async () => {
    const prefilteredMethodsObject = [{ prefilteredMethods: "data" }];
  ...
  test("getPrefilteredMatsMethods", async () => {
    const prefilteredMatsMethodsObject = [{ prefilteredMatsMethods: "data" }];

    const prefilteredMatsMethodsUrl = `${dataManagementBaseUrl}/relationships/mats-methods`;
    mock
      .onGet(prefilteredMatsMethodsUrl)
      .reply(200, prefilteredMatsMethodsObject);
  ...
  test("getPrefilteredSpans", async () => {
    const prefilteredSpansObject = [{ prefilteredSpans: "data" }];
  ...
  test("getPrefilteredDefaults", async () => {
    const prefilteredDefaultsObject = [{ prefilteredDefaults: "data" }];
  ...
  test("getPrefilteredLoads", async () => {
    const prefilteredLoadsObject = [{ prefilteredLoads: "data" }];
  ...
  test("prefilteredLEEQualifications", async () => {
    ...
    mock
      .onGet(prefilteredLEEQualificationsUrl)
      .reply(200, prefilteredLEEQualificationsObject);
  ...
  test("getPrefilteredUnitFuels", async () => {
    const prefilteredUnitFuelsObject = [{ prefilteredUnitFuels: "data" }];
  ...
  test("getPrefilteredUnitControls", async () => {
    const prefilteredUnitControlsObject = [{ prefilteredUnitControls: "data" }];

    const prefilteredUnitControlsUrl = `${dataManagementBaseUrl}/relationships/unit-controls`;
    mock
      .onGet(prefilteredUnitControlsUrl)
      .reply(200, prefilteredUnitControlsObject);
  ...
  test("getPrefilteredSystemFuelFlows", async () => {
    ...
    mock
      .onGet(prefilteredSystemFuelFlowsUrl)
      .reply(200, prefilteredSystemFuelFlowsObject);
  ...
  test("getPrefilteredSystemComponents", async () => {
    ...
    mock
      .onGet(prefilteredSystemComponentsUrl)
      .reply(200, prefilteredSystemComponentsObject);
  ...
  test("getAllTestTypeCodes", async () => {
    const testTypeCodesObject = [{ testTypeCodes: "data" }];
  ...
  test("getAllTestResultCodes", async () => {
    const testResultCodesObject = [{ testResultCodes: "data" }];
  ...
  test("getAllTestReasonCodes", async () => {
    const testReasonCodesObject = [{ testReasonCodes: "data" }];
  ...
  test("getAllGasLevelCodes", async () => {
    const gasLevelCodesObject = [{ gasLevelCodes: "data" }];
  ...
  test("getAllGasTypeCodes", async () => {
    const gasTypeCodesObject = [{ gasTypeCodes: "data" }];
  ...
  test("getPrefilteredTestSummaries", async () => {
    ...
    mock
      .onGet(prefilteredTestSummariesUrl)
      .reply(200, prefilteredTestSummariesObject);
  ...
  test("getAllRataFreqCodes", async () => {
    const rataFreqCodesObject = [{ rataFreqCodes: "data" }];
  ...
  test("getAllApsCodes", async () => {
    const apsCodesObject = [{ apsCodes: "data" }];
  ...
  test("getAllReferenceMethodCodes", async () => {
    const referenceMethodCodesObject = [{ referenceMethodCodes: "data" }];
  ...
  test("getAllRunStatusCodes", async () => {
    const runStatusCodesObject = [{ runStatusCodes: "data" }];
  ...
  test("getAllPressureMeasureCodes", async () => {
    const pressureMeasureCodesObject = [{ pressureMeasureCodes: "data" }];
  ...
  */
  ...
  test("getMdmDataByCodeTable", async () => {
    const mdmDataByCodeTableObject = [{ mdmDataByCodeTable: "data" }];
  ...
  test("getAllAccuracyTestMethodCodes", async () => {
    const accuracyTestMethodCodesObject = [{ accuracyTestMethodCodes: "data" }];

    const accuracyTestMethodCodesUrl = `${dataManagementBaseUrl}/accuracy-test-method-codes`;
    mock
      .onGet(accuracyTestMethodCodesUrl)
      .reply(200, accuracyTestMethodCodesObject);
  ...
  test("getAllAccuracySpecCodes", async () => {
    const accuracySpecCodesObject = [{ accuracySpecCodes: "data" }];
