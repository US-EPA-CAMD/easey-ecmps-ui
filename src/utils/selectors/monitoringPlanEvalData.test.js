...
describe("testing monitoring plan evaluation data selector", () => {
        ...
        monitoringEvalDataTableRecods = [
            {
                ...
                col2: "Severity 1",
                col3: "category 1",
                col4: <span className="text-informational"><u>Check Code 1</u></span>,
            ...
            },
            {
                ...
                col2: "Severity 2",
                col3: "category 2",
                col4: <span className="text-informational"><u>Check Code 2</u></span>,
            ...
            },
            {
                ...
                col2: "Severity 3",
                col3: "category 3",
                col4: <span className="text-informational"><u>Check Code 3</u></span>,
    ...
    test("should generate table records for monitoring plan eval data", () => {
        expect(
            fs.getMonitoringPlansEvalData(selectedMonitoringEvalData)
        ).toEqual(monitoringEvalDataTableRecods);
    });
});